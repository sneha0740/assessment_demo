import { GenericConstructor, Rule, Rules } from './mapping.highlevel';
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function integerProperty(config?: Rule & {
    acceptNumber?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function localTimeProperty(config?: Rule & {
    stringify?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function timeProperty(config?: Rule & {
    stringify?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function dateProperty(config?: Rule & {
    stringify?: boolean;
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function localDateTimeProperty(config?: Rule & {
    stringify?: boolean;
    jsNativeDate?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function dateTimeProperty(config?: Rule & {
    stringify?: boolean;
    jsNativeDate?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function uuidProperty(config?: Rule & {
    stringify?: boolean;
}): (_: any, context: any) => void;
/**
 ...
 * @experimental Object Mapping Decorators are in preview and may change in minor releases.
 */
declare function objectProperty(constructorOrRules: GenericConstructor<Object> | Rules, rules?: Rules): (_: any, context: any) => void;
/**
...
declare const forExport: {
    ...
    localTimeProperty: typeof localTimeProperty;
    timeProperty: typeof timeProperty;
    dateProperty: typeof dateProperty;
    localDateTimeProperty: typeof localDateTimeProperty;
