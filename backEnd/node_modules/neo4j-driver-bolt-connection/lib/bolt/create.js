...
var bolt_protocol_v6x1_1 = __importDefault(require("./bolt-protocol-v6x1"));
...
function createProtocol(version, server, chunker, packingConfig, serversideRouting, createResponseHandler, onProtocolError, log) {
    ...
    switch (true) {
        ...
        case version.isEqualTo({ major: 6, minor: 1 }):
            return new bolt_protocol_v6x1_1.default(server, chunker, packingConfig, createResponseHandler, log, onProtocolError, serversideRouting);
        default:
            throw (0, neo4j_driver_core_1.newError)('Unknown Bolt protocol version: ' + version);
    }
}
