...
var Packer = /** @class */ (function () {
     ...
     */
    function Packer(channel, allowUUID) {
        if (allowUUID === void 0) { allowUUID = false; }
        this._ch = channel;
    ...
    Packer.prototype.packable = function (x, dehydrateStruct) {
        ...
        else if ((0, neo4j_driver_core_1.isUUID)(x)) {
            if (this.allowUUID) {
                return function () { return _this.packUUID(x); };
            }
            else {
    ...
    Packer.prototype.packUUID = function (x) {
        this._ch.writeUInt8(UUID_MARKER);
        var array = x.getTypedArray();
        for (var i = 0; i < array.length; i++) {
...
var Unpacker = /** @class */ (function () {
     ...
     */
    function Unpacker(disableLosslessIntegers, useBigInt, allowUUID) {
    ...
    Unpacker.prototype.unpack = function (buffer, hydrateStructure) {
        ...
        var uuid = this._unpackUUID(marker, buffer);
        if (uuid !== null) {
            return uuid;
        }
    ...
    Unpacker.prototype._unpackUUID = function (marker, buffer) {
        if (marker === UUID_MARKER && this.allowUUID === true) {
            var value = new Uint8Array(16);
            for (var i = 0; i < 16; i++) {
                value[i] = buffer.readUInt8();
            }
            return new neo4j_driver_core_1.UUID(value);
        }
        return null;
    };
